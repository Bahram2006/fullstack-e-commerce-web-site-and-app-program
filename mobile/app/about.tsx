...
import { StyleSheet, View, Text, ScrollView, StatusBar, Linking, TouchableOpacity } from "react-native";
      ...
      >
        <View style={styles.textCard}>
          ...
          <Text style={styles.paragraphText}>
            <Text style={styles.boldRedText}>“Sumbar Computer”</Text> dükany 2010-njy ýylda esaslandyryldy we korporatiw pudak we hususy müşderiler üçin IT enjamlarynyň ähli toplumynyň ygtybarly üpjün edijisi bolup durýar. Kompýuter enjamlarynyň bölek we lomaý satuw dükany.
          </Text>

          <Text style={styles.paragraphText}>
            <Text style={styles.boldRedText}>“Sumbar Computer”</Text> şu harytlaryň dürli görnüşlerini hödürleýär: şahsy kompýuterler, aýratyn toplumlaşdyryjylar, noutbuklar, periferiýa gurluşlary, kompýuter esbaplary, printerler, ofis guramaçylykly tehnikasy, öýjükli periferiýa we dünýäniň öňdebaryjy öndürijilerinden başga harytlar.
          </Text>

          {/* 1. SC-niň esasy harytlary */}
          <Text style={styles.subHeadingText}>SC-niň esasy harytlary:</Text>
          <View style={styles.listWrapper}>{renderBulletList(mainProducts)}</View>

          {/* 2. Korporatiw müşderiler */}
          <Text style={styles.subHeadingText}>Korporatiw müşderiler üçün enjamlar bilen üpjün etmek we taslamalary durmuşa geçirmek üçin hyzmatlaryň doly toplumy hödürlenýär:</Text>
          <View style={styles.listWrapper}>{renderBulletList(corporateItems)}</View>

          {/* 3. Bölek satuw müşderileri */}
          <Text style={styles.subHeadingText}>Bölek satuw müşderileri üçin:</Text>
          <View style={styles.listWrapper}>{renderBulletList(retailItems)}</View>

          {/* 4. Hyzmatlaryň doly görnüşi */}
          <Text style={styles.subHeadingText}>Müşderilerimiz üçin hyzmatlaryň doly görnüşi:</Text>
          <View style={styles.listWrapper}>{renderBulletList(serviceItems)}</View>

          {/* 5. Iş wagty bölümi */}
          <View style={styles.sectionDivider} />
          <Text style={styles.sectionHeadingText}>Iş wagty:</Text>
          <Text style={styles.infoDetailText}>Iş günleri: 9:00-dan 19:00-a çenli.</Text>
          <Text style={styles.infoDetailText}>Dynç güni: с 11:00-dan 19:00-a çenli.</Text>
          <Text style={styles.infoDetailTextSub}>Dükan we eltip bermek hyzmaty baýramçylyk günlerinde işlemeýär.</Text>

          {/* 6. Habarlaşmak bölümi */}
          <View style={styles.sectionDivider} />
          <Text style={styles.sectionHeadingText}>Habarlaşmak üçün:</Text>
          
          <TouchableOpacity activeOpacity={0.7} onPress={() => Linking.openURL("tel:+99312492343")}>
            <Text style={styles.infoDetailText}><Text style={styles.boldLabel}>Tel.:</Text> +993 (12) 49-23-43, +993 (12) 26-13-69, +993 (62) 70-80-45</Text>
          </TouchableOpacity>

          <TouchableOpacity activeOpacity={0.7} onPress={() => Linking.openURL("mailto:sumbar.computer@gmail.com")}>
            <Text style={styles.infoDetailText}><Text style={styles.boldLabel}>e-mail:</Text> sumbar.computer@gmail.com</Text>
          </TouchableOpacity>

          <Text style={styles.infoDetailText}><Text style={styles.boldLabel}>Instagram:</Text> sumbarcomputer_official</Text>
          
          <Text style={styles.addressText}>
            Dükanymyz A.Nyýazow (Hudayberdiýew, 4 mkr.) köçesi, 99 jaý salgysy boýunça Aşgabat şäheriniň merkezinde ýerleşýär (Hudaýberdiýew köçäniň hem-de Bomako köçäniň çatrygy, AŞTU-nyň garşysy)
          </Text>
